...
######################
#write shapefile
shapefile(spdf, "stateS/hex_file/usa_s.shp", overwrite = TRUE)
...
#export
write_csv(centers, "states/hex_file/usa_s_centers.csv")
...
#export
write_csv(spdf_fort, "states/hex_file/usa_s_fort.csv")
