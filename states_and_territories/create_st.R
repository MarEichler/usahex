...
spdf <- SpatialPolygons(list(
  ...
  , Polygons(list(Polygon(tribble( ~x, ~y,  52.845997 , -270,  70.1665051, -280,  70.1665051, -300,  52.845997 , -310,  35.5254889, -300,  35.5254889, -280,  52.845997 , -270))), ID = "AS")
  ...
  , Polygons(list(Polygon(tribble( ~x, ~y,  18.204981 , -270,  35.5254891, -280,  35.5254891, -300,  18.204981 , -310,   0.8844729, -300,   0.8844729, -280,  18.204981 , -270))), ID = "GU")
  ...
  #for when not showing territories
  # , Polygons(list(Polygon(tribble( ~x, ~y,  18.2050808, -210, 35.5255888, -220, 35.5255888, -240, 18.2050808, -250, 0.884572681, -240, 0.884572681, -220, 18.2050808, -210))), ID = "HI")
  ))
...
######################
#write shapefile
shapefile(spdf, "states_and_territories/hex_file/usa_st.shp", overwrite = TRUE)
...
#export
write_csv(centers, "states_and_territories/hex_file/usa_st_centers.csv")
...
#export
write_csv(spdf_fort, "states_and_territories/hex_file/usa_st_fort.csv")
